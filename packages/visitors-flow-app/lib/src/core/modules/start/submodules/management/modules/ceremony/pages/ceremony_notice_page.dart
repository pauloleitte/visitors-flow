...
class CeremonyNoticePage<T> extends StatefulWidget {
  final MultiSelectParams params;
  const CeremonyNoticePage({
    required this.params,
    Key? key,
  }) : super(key: key);

  @override
  State<CeremonyNoticePage> createState() => _CeremonyNoticePageState();
}

class _CeremonyNoticePageState extends State<CeremonyNoticePage> {
